<?php
// Clear any previous output or whitespace so headers work correctly
if (ob_get_level()) {
    ob_end_clean();
}
...
// 4. Fetch the data from the database using PDO safely
try {
    ...
    fputcsv($output, array('Error fetching data: ' . $e->getMessage()));
}
